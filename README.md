...
```
cd existing_repo
git remote add origin https://git.toprate.io/search-integrator/si-api.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.toprate.io/search-integrator/si-api/-/settings/integrations)
